...
<!-- 年月日を表示 -->
        <h2 class="pagetitle"><?php printf(_x(' %s|Daily archive page', 'kubrick'), get_the_time(__('F jS, Y', 'kubrick'))); ?>年</h2>
<!-- 月別アーカイブの場合 *2 -->
       <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
<!-- 年月を表示 -->
        <h2 class="pagetitle"><?php printf(_x(' %s|Monthly archive page', 'kubrick'), get_the_time(__('F, Y', 'kubrick'))); ?>年</h2>
<!-- 年別アーカイブの場合 *2 -->
       <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
<!-- 年を表示 -->
        <h2 class="pagetitle"><?php printf(_x('Archive for %s|Yearly archive page', 'kubrick'), get_the_time(__('Y', 'kubrick'))); ?></h2>
<!-- 著者アーカイブの場合 *2 -->
...
<!-- 年月日を表示 -->
<div id="date"><?php the_time(__('Y年m月d日')) ?></div>
